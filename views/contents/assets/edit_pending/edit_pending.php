...
<html lang="fr">
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="section">
                <form action="<?=$router->url('edit_denied',['id'=>$nft->id,'creator'=>'@'.$nft->username])?>" method="post"  enctype="multipart/form-data" class="active"  >
               ...
               <div class="image">
                    ...
                    <img  id="blah" src="../../../SS/images/<?=$nft->dir_nft?>" alt="" style="width: 100%;height:200px;margin-bottom:10px;">
                </div> 
                <?= Form::errorsHTML('file',$errors)?>
                <input type="submit" name="submit" value="Re-submit" placeholder="Submit">
